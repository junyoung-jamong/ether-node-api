...
router.get('/', function(req, res){
    async.parallel([
        function(callback){
            getListbyQuery(QUERY_CPU_USAGE_LIST, FIELD_CPU, callback);
        },
        function(callback){
            getListbyQuery(QUERY_MEMORY_USAGE_LIST, FIELD_MEMORY, callback);
        },
        function(callback){
            getListbyQuery(QUERY_DISK_USAGE_LIST, FIELD_DISK, callback);
        },
        function(callback){
            getListbyQuery(QUERY_NETWORK_RECEIVE_LIST, FIELD_NETWORK_RECEIVE, callback);
        },
        function(callback){
            getListbyQuery(QUERY_NETWORK_TRANSMIT_LIST, FIELD_NETWORK_TRANSMIT, callback);
        }
...
router.get('/disk/:node_id', function(req, res){
	...
	return requestNodeRangeQuery(query, res)
})
...
function getListbyQuery(query, field, callback){
    request(query, function(err, response, body){
        if(err){
            var result = {
                result: false,
